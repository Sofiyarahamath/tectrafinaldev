...
export default function CTAGradientSection() {
  return (
    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden px-4 md:px-8 py-12 xl:py-16">
      <Image
      ...
      <div className="relative z-10 flex w-full max-w-7xl mx-auto flex-col items-stretch justify-start gap-8 rounded-[24px] bg-white p-6 sm:rounded-[32px] sm:p-8 lg:flex-row lg:items-center lg:gap-12 lg:rounded-[40px] xl:h-[674.70px] xl:p-11">
        <div className="inline-flex w-full max-w-[521px] flex-col items-start justify-between lg:self-stretch">
          ...
          <div className="flex w-full flex-col items-start justify-start pt-8">
            <div className="flex h-auto sm:h-48 w-full max-w-96 flex-col items-start justify-start overflow-hidden rounded-2xl bg-neutral-900 outline outline-[0.80px] outline-offset-[-0.80px] outline-neutral-800">
